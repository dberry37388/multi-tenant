...
return [
    ...
    'website' => [
         ...
         */
        'disk' => env('TENANCY_FILESYSTEM_DISK', null),
         ...
         */
        'auto-create-tenant-directory' => env('TENANCY_AUTO_CREATE_TENANT_DIRECTORY', true),
         ...
         * @info set to false to disable.
         */
        'auto-rename-tenant-directory' => env('TENANCY_AUTO_RENAME_TENANT_DIRECTORY', false),
         ...
         */
        'auto-delete-tenant-directory' => env('TENANCY_AUTO_DELETE_TENANT_DIRECTORY', false),

        /**
         * Time to cache websites in minutes. Set to false to disable.
         */
        'cache' => env('TENANCY_CACHE_WEBSITE', 10),
    ],
    'hostname' => [
        /**
         ...
         */
        'abort-without-identified-hostname' => env('TENANCY_ABOUT_WITHOUT_IDENTIFIED_HOSTNAME', true),

        /**
         * Time to cache hostnames in minutes. Set to false to disable.
         */
        'cache' => env('TENANCY_CACHE_HOSTNAME', 10),
...
//        'tenant-seed-class' => App\Seeders\AdminSeeder::class,
         ...
         * @info set to false to disable.
         */
        'auto-create-tenant-database' => env('TENANCY_AUTO_CREATE_TENANT_DATABASE', true),
         ...
         * @info set to false to disable.
         */
        'auto-create-tenant-database-user' => env('TENANCY_AUTO_CREATE_TENANT_DATABASE_USER', true),
         ...
         * @info set to false to disable.
         */
        'auto-rename-tenant-database' => env('TENANCY_AUTO_RENAME_TENANT_DATABASE', true),
